...
//} else {
//    print("Unale to retrieve the address.")
//}
...
//johnsAddress.residence?.address = johnsAddress
//
//if let johnStreet = john.residence?.address?.street {
...
//    print("John's bullding indetifier is \(buildingIdentiier).")
//}
//// Prints "John's building indetifier is The Larches."
//
//if let beginsWithThe =
//    john.residence?.address?.buildingIdentifier()?.hasPrefix("The") {
//if beginsWithThe {
//    print("John's building indetifier begins with \"The\".")
//} else {
//    print("John's building indetifier does not begin with \"The\".")
//// Prints "John's building identifier begins with "The"."

// That was the end of Optionals
